...
activities = {
    ...
    "Basketball Club": {
        "description": "Train for basketball skills and play friendly games",
    ...
    "Drama Club": {
        "description": "Prepare and perform scenes, improv, and theater productions",
        "schedule": "Thursdays, 3:30 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["amelia@mergington.edu", "ethan@mergington.edu"]
    },
    "Math Team": {
        "description": "Solve advanced math problems and compete in math competitions",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["jack@mergington.edu", "chloe@mergington.edu"]
    },
    "Science Olympiad": {
        "description": "Build science projects and prepare for science olympiad events",
